...
public class ArrayBuffer<T> extends AbstractList<T> implements Buffer<T> {
    ...
    /**
     * @see org.java0.util.collections.Buffer#add(java.lang.Object)
     */
    @Override
...
//            }
    ...
    /**
     * @see org.java0.util.collections.Buffer#remainingCapacity()
     */
    @Override
    ...
    /**
     * @see org.java0.util.collections.Buffer#hasArray()
     */
    @Override
    ...
    /**
     * @see org.java0.util.collections.Buffer#array()
     */
    @Override
    public T[] array() {
        return elements;
    ...
    /**
     * @see org.java0.util.collections.Buffer#arrayOffset()
     */
    @Override
    ...
    /**
     * @see org.java0.util.collections.Buffer#getArray()
     */
    @Override
    public T[] getArray() {
        @SuppressWarnings("unchecked")
    ...
    /**
     * @see org.java0.util.collections.Buffer#isReadOnly()
     */
    @Override
