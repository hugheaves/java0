...
public class GenericUnitTest extends BaseTest {
    private static final Logger logger = Logger.getLogger(GenericUnitTest.class.getName());
    ...
    // public void tesT0() {
    //
    // final UnitProduct<NumericProduct, Numeric, Numeric> ab = a.multiply(b);
    //
    ...
    // @Test
    // public void test2() {
    // final UnitProduct<QuantityProduct<Numeric, Numeric>, Numeric, Numeric>
    // dadb = da.multiply(db);
    ...
    // @Test
    // public void test5() {
    // final UnitQuotient<QuantityQuotient<Numeric, Numeric>, Numeric, Numeric>
    // ab = a.divide(b);
    // logger.info(ab.getName());
    //
    // assertEquals(0.5, ab.convertToSystem(0.5).doubleValue(), SMALL_AMOUNT);
    ...
    // logger.info(mbda.getName());
    //
    // final UnitQuotient<QuantityQuotient<QuantityQuotient<Numeric, Numeric>,
    // Numeric>, QuantityQuotient<Numeric, Numeric>, Numeric> mbdaca = mbda
    // .divide(ca);
    //
    ...
    // logger.info(mbdaca.getName());
    //
    // final UnitProduct<QuantityProduct<Numeric,
    // QuantityQuotient<QuantityQuotient<Numeric, Numeric>, Numeric>>, Numeric,
    // QuantityQuotient<QuantityQuotient<Numeric, Numeric>, Numeric>> dbmbdaca =
    // db
    // .multiply(mbdaca);
    // logger.info(mbdaca.getName());
    //
