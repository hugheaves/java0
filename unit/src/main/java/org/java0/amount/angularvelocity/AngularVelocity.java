...
import org.java0.amount.NumericAmountImpl;
...
public class AngularVelocity extends
		NumericAmountImpl<NumericUnitQuotient<AngleUnit, TimeUnit>> {

	/**
	 * @param value
	 * @param unit
	 */
	public AngularVelocity(Number value, NumericUnitQuotient<AngleUnit, TimeUnit> unit) {
		super(value, unit);
	}
}
