 ...
 *            the generic type
 */
public interface BinaryUnit<UNIT_1_TYPE extends Unit<?, ?>, UNIT_2_TYPE extends Unit<?, ?>, UNIT_TYPE extends BinaryUnit<UNIT_1_TYPE, UNIT_2_TYPE, UNIT_TYPE>>
        extends Unit<UNIT_TYPE, UNIT_TYPE> {
    /**
