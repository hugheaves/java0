...
public class InjectableProvider<T> extends DefaultProvider<T> implements
    ...
    /**
     * @see org.java0.util.factory.InjectableObject#getInjectableField()
     */
    @Override
    ...
    /**
     * @see org.java0.util.factory.InjectableObject#setInjectableValues(org.java0.util.factory.InjectableValues)
     */
    @Override
