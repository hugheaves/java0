...
public class ArraySetTest extends BaseTest {
	private static final Logger logger = LoggerFactory
			.getLogger(ArraySetTest.class.getName());
	...
	static List<List<Integer>> addLists = genAddList(NUM_LISTS, MIN_ADD_VALUES,
			MAX_ADD_VALUES, MAX_VALUE);;
	...
	public void timedComparison() {
		...
		logger.info("element counts", "hashTotalElementsAdded",
				hashTotalElementsAdded, "arrayTotalElementsAdded",
				arrayTotalElementsAdded, "hashTotalElementsRemaining",
				hashTotalElementsRemaining, "arrayTotalElementsRemaining",
				arrayTotalElementsRemaining);
		hash.log(Level.INFO);
